...
class GeneratedTest(Base):
    ...
    progress_mcq: Mapped[int] = mapped_column(Integer, nullable=False, default=0)  # UI progress (timer + real overwrite)
    total_mcq: Mapped[int] = mapped_column(Integer, nullable=False, default=0)  # requested total for progress denominator
