...
upload UPSC coaching notes (PDF) → extraction runs in background → generate 1–20 Prelims-style MCQs (text pipeline: chunk → LLM → filter/sort). Review/edit, manual fill for partial tests, export to .docx. PDF only; no paste.
